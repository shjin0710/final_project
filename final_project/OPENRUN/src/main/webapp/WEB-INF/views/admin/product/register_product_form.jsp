...
<head>
<meta charset="UTF-8">
<link href="<c:url value='/resources/common/css/sellerMypage.css' />" rel="stylesheet" type="text/css">
			...
			<div>
				...
				<div class="register_product_form">
					<form action="<c:url value='/product/admin/registerProductConfirm' />" name="register_product_form" method="post" enctype="multipart/form-data">
						...
						<input type="text" name="p_name" style=width:510px  placeholder="제목을 입력해주세요." required> <br>
